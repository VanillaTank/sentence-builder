...
export const ACTIVE_PRESENT_PERFECT_CONTINUOUS: Card = {
    title: "ACTIVE PRESENT PERFECT CONTINUOUS",
    mainFilter: 'general',
    cardFilter: {
        time: 'present',
        timeType: 'perfect continuous',
        voice: 'active'
    },
    ...
    examples: [
        {
            en: "I have already been writting my report for three hours.",
            ru: "Я пишу это письмо уже три часа.",
            exampleFilter: {
                pronoun: "I",
                verb: "irregular",
        ...
        {
            en: "Wake up! We have been sleeping for ten hours alreadу.",
            ru: "Вставай! Мы проспали уже 10 часов",
            exampleFilter: {
                pronoun: "we",
                verb: "irregular",
                sentenceType: "statement"
        ...
        //   },
        {
            en: "Today she has been helping her mother since morning.",
            ru: "Сегодня она помогает своей маме с утра.",
            exampleFilter: {
                pronoun: "heSheIt",
                verb: "irregular",
                sentenceType: "statement"
